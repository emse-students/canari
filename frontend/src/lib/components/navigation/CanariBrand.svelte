<script lang="ts">
  ...
  <div
    class="relative flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-cn-grey to-cn-grey-hover shadow-sm border border-black/5 dark:border-white/10 overflow-hidden group-hover:scale-105 transition-transform duration-300"
  >
