<script lang="ts">
  ...
  const headingClasses = $derived(
    compact
      ? '[&_h1]:text-[1em] [&_h1]:leading-tight [&_h1]:font-bold [&_h2]:text-[1em] [&_h2]:font-bold [&_h3]:text-[1em] [&_h3]:font-bold'
      : '[&_h1]:text-[1.526em] [&_h1]:leading-tight [&_h1]:font-bold [&_h2]:text-[1.316em] [&_h2]:font-bold [&_h3]:text-[1.158em] [&_h3]:font-bold'
  );
</script>
