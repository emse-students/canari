...
>
  ...
  <div
    class="flex items-center justify-between border-b border-black/5 dark:border-white/10 p-4 bg-white/50 dark:bg-black/40 backdrop-blur-md"
  >
  ...
  <div class="flex-1 p-3 overflow-hidden">
    ...
    >
      <div
        class="font-mono text-[11px] sm:text-xs text-green-400 space-y-1.5 selection:bg-green-400/30"
      >
        {#if logs.length === 0}
        ...
        {#each logs as entry, i (i)}
          <div
            class="border-b border-white/5 pb-1.5 break-all opacity-90 hover:opacity-100 transition-opacity"
          >
