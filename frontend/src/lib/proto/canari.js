...
export const canari = ($root.canari = (() => {
  ...
  canari.WsEnvelope = (function () {
    ...
    WsEnvelope.decode = function decode(reader, length, error) {
      ...
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.canari.WsEnvelope();
    ...
    WsEnvelope.fromObject = function fromObject(object) {
      if (object instanceof $root.canari.WsEnvelope) return object;
  ...
  canari.Recipient = (function () {
    ...
    Recipient.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.canari.Recipient();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    Recipient.fromObject = function fromObject(object) {
      if (object instanceof $root.canari.Recipient) return object;
  ...
  canari.MlsFrame = (function () {
    ...
    MlsFrame.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.canari.MlsFrame();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    MlsFrame.fromObject = function fromObject(object) {
      if (object instanceof $root.canari.MlsFrame) return object;
    ...
    MlsFrame.toObject = function toObject(message, options) {
      if (!options) options = {};
      let object = {};
      if (options.arrays || options.defaults) object.recipients = [];
      if (options.defaults) {
  ...
  canari.WelcomeFrame = (function () {
    ...
    WelcomeFrame.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.canari.WelcomeFrame();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    WelcomeFrame.fromObject = function fromObject(object) {
      if (object instanceof $root.canari.WelcomeFrame) return object;
  ...
  canari.ReadAck = (function () {
    ...
    ReadAck.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.canari.ReadAck();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    ReadAck.fromObject = function fromObject(object) {
      if (object instanceof $root.canari.ReadAck) return object;
    ...
    ReadAck.toObject = function toObject(message, options) {
      if (!options) options = {};
      let object = {};
      if (options.defaults) object.messageId = '';
      if (message.messageId != null && message.hasOwnProperty('messageId'))
  ...
  canari.InboundMsg = (function () {
    ...
    InboundMsg.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.canari.InboundMsg();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    InboundMsg.verify = function verify(message) {
      ...
      if (message.senderId != null && message.hasOwnProperty('senderId'))
        if (!$util.isString(message.senderId)) return 'senderId: string expected';
      if (message.senderDeviceId != null && message.hasOwnProperty('senderDeviceId'))
        if (!$util.isString(message.senderDeviceId)) return 'senderDeviceId: string expected';
      if (message.groupId != null && message.hasOwnProperty('groupId'))
        if (!$util.isString(message.groupId)) return 'groupId: string expected';
      if (message.isWelcome != null && message.hasOwnProperty('isWelcome'))
        if (typeof message.isWelcome !== 'boolean') return 'isWelcome: boolean expected';
      return null;
    };
    ...
    InboundMsg.fromObject = function fromObject(object) {
      if (object instanceof $root.canari.InboundMsg) return object;
      ...
      if (object.senderId != null) message.senderId = String(object.senderId);
      if (object.senderDeviceId != null) message.senderDeviceId = String(object.senderDeviceId);
      if (object.groupId != null) message.groupId = String(object.groupId);
      if (object.isWelcome != null) message.isWelcome = Boolean(object.isWelcome);
      return message;
    };
  ...
  canari.AppMessage = (function () {
    ...
    AppMessage.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.canari.AppMessage();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    AppMessage.verify = function verify(message) {
      ...
      if (message.reaction != null && message.hasOwnProperty('reaction')) {
        ...
        properties.kind = 1;
        {
          ...
          if (error) return 'reaction.' + error;
        }
      }
    ...
    AppMessage.fromObject = function fromObject(object) {
      if (object instanceof $root.canari.AppMessage) return object;
  ...
  canari.TextMsg = (function () {
    ...
    TextMsg.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.canari.TextMsg();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    TextMsg.fromObject = function fromObject(object) {
      if (object instanceof $root.canari.TextMsg) return object;
  ...
  canari.ReplyRef = (function () {
    ...
    ReplyRef.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.canari.ReplyRef();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    ReplyRef.fromObject = function fromObject(object) {
      if (object instanceof $root.canari.ReplyRef) return object;
  ...
  canari.ReplyMsg = (function () {
    ...
    ReplyMsg.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.canari.ReplyMsg();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    ReplyMsg.fromObject = function fromObject(object) {
      if (object instanceof $root.canari.ReplyMsg) return object;
  ...
  canari.ReactionMsg = (function () {
    ...
    ReactionMsg.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.canari.ReactionMsg();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    ReactionMsg.fromObject = function fromObject(object) {
      if (object instanceof $root.canari.ReactionMsg) return object;
  ...
  canari.MediaMsg = (function () {
    ...
    MediaMsg.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.canari.MediaMsg();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    MediaMsg.fromObject = function fromObject(object) {
      if (object instanceof $root.canari.MediaMsg) return object;
      ...
      if (message.kind != null && message.hasOwnProperty('kind'))
        object.kind =
          options.enums === String
            ? $root.canari.MediaKind[message.kind] === undefined
              ? message.kind
              : $root.canari.MediaKind[message.kind]
            : message.kind;
      if (message.mediaId != null && message.hasOwnProperty('mediaId'))
  ...
  canari.SystemMsg = (function () {
    ...
    SystemMsg.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.canari.SystemMsg();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    SystemMsg.fromObject = function fromObject(object) {
      if (object instanceof $root.canari.SystemMsg) return object;
