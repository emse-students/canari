...
export class WasmMlsClient {
  ...
  constructor(user_id, state_bytes, pin) {
    ...
    var ptr2 = isLikeNone(pin)
      ? 0
      : passStringToWasm0(pin, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
  ...
  process_incoming_message_bytes(group_id, message_bytes) {
    ...
    const ptr1 = passArray8ToWasm0(message_bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.wasmmlsclient_process_incoming_message_bytes(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
...
const WasmMlsClientFinalization =
