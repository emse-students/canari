...
## 8. Fonctionnalités Futures & Améliorations
* **Mise à l'échelle automatique** des services via Kubernetes.
* **Surveillance & Alerting** avec Prometheus + Grafana.
* **Tests de charge** pour valider la scalabilité.
* **Service de VoIP** pour appels audio/vidéo en temps réel.
* **Interactions entre les utilisateurs** (Likes, Shares, Comments, Pokes).
