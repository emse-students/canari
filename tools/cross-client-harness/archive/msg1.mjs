 ...
 *
 *   bun msg1.mjs           steady state - the conversation is already open on both sides
 *   bun msg1.mjs --cold    the FIRST message into a conversation just opened on the receiver
 *
