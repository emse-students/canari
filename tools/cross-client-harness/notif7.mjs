 ...
 *
 *   node notif7.mjs bg      the app is backgrounded (alive, HOME pressed)
 *   node notif7.mjs killed  the app is dead (`am kill` from HOME, asserted)
 *
...
if (!['bg', 'killed'].includes(mode)) throw new Error(`usage: node notif7.mjs bg|killed`);
