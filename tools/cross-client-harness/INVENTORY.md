...
One QUESTION each, composed of gestures, ending in a verdict in `results.ndjson`. They still run and the 14 gated self-tests live here. See [`archive/README.md`](archive/README.md).
