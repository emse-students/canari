...
launch_terminal "Post Service (Node)" "apps/post-service" "PORT=3006 USER_SERVICE_URL='http://localhost:3004' POSTS_MONGO_URI='mongodb://localhost:27017/post_db' npm install && npm run start:dev"
