...
- CHANGELOG: one **SHORT** entry under `[Unreleased]` per change - a sentence or two and a LINK (user, 2026-09-17). Reasoning, measurements and what was refuted go on the wiki page it points at. A long entry is not a thorough one, it is one nobody reads - and that records nothing.
