...
10. **UX/RENDERING - THE ROUTE SWEEP IS DONE; WHAT IS OPEN IS REAL HARDWARE (all of it Chrome with
    an override), the channel list's width, FIVE of the ELEVEN 2026-09-18 REPORTS (first contact
    with no history, back with no home, the composer band, two reaction items), and THE PHONE
