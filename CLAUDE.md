...
1. **PHASE 1 IS FULLY DONE, ALL THREE ESTATES** - data, traffic, the runner flip AND the crontab move (section 10, steps 5-6), confirmed live 2026-09-24. **PHASE 2, NOT REVERSIBLE, IS OPEN AND SCOPED BY THE USER TO `canari-emse.fr` -> `canari.emse.fr` ONLY** (cercle/miconnect renames are NOT in this phase) - propagate through the app, miconnect's OIDC config, links, deep links, and both store consoles ([estate-migration](docs/wiki/infrastructure/estate-migration.md#10-the-ordered-list---written-2026-09-24-data-and-traffic-now-done-for-all-three-estates)).
