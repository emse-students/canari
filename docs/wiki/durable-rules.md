...
- **AN ABSENT ANSWER IS NOT A NEGATIVE ANSWER** - `undefined` from a server that was not asked, or a fetch that threw, must leave behaviour EXACTLY as it was; only a present-and-empty list is the statement "this group would deliver you nothing". [graine](protocols/channel-encryption.md#the-asymmetry-has-a-third-half-coming-back---fixed-2026-08-21-wp-regrant-1)
