...
Tactics used to keep **server routing / epoch tracking**, **OpenMLS group state**, and **delivery order** aligned. Pair with [MLS_RECOVERY_LADDER.md](./MLS_RECOVERY_LADDER.md) for what happens *after* a fault is detected.
...
| Recovery vs prevention | Desync *handling* (ACK rules, retries) | [MLS_RECOVERY_LADDER.md](./MLS_RECOVERY_LADDER.md) |
